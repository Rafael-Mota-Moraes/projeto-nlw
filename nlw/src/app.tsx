...
export function App() {
  ...
  function handleSearh(event: ChangeEvent<HTMLInputElement>) {
    ...
    <div className="mx-auto max-w-6xl my-12 space-y-6 px-6">
      ...
      <form className="w-full">
        <input
          ...
          className="w-full bg-transparent text-3xl font-semiboldtracking-tight placeholder:text-slate-500 outline-none"
